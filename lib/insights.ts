...
export const insightPosts: InsightPost[] = [
  {
    slug: "luxury-jewelry-brand-advertising",
    title: "Luxury Jewelry Advertising: Programmatic & CTV Strategy",
    excerpt: "A media strategist's guide to luxury jewelry advertising - CPM benchmarks, the gifter-versus-wearer problem, seasonal flighting, and measurement.",
    image: "/images/luxury-jewelry-brand-advertising.png",
    category: "Vertical Strategy",
    date: "2026-09-14",
  },
  {
    slug: "incremental-cost-per-acquisition-luxury-brands",
    title: "Incremental Cost Per Acquisition: The Real CAC Metric",
    excerpt: "Incremental cost per acquisition explained: how to calculate iCPA from holdout tests, channel benchmark ranges, and how to budget against marginal iCPA.",
    image: "/images/incremental-cost-per-acquisition-luxury-brands.png",
    category: "Measurement & Analytics",
    date: "2026-09-15",
  },
  {
    slug: "luxury-travel-advisor-tour-operator-advertising",
    title: "Luxury Travel Advisor Advertising: The Media Playbook",
    excerpt: "Luxury travel advisor advertising that works: CPM benchmarks, booking-cycle math, channel mix by trip value, and how to measure a 9-month sales cycle.",
    image: "/images/luxury-travel-advisor-tour-operator-advertising.png",
    category: "Vertical Playbooks",
    date: "2026-09-15",
  },
  {
    slug: "private-aviation-customer-acquisition-cost-benchmarks",
    title: "Private Aviation Customer Acquisition Cost Benchmarks",
    excerpt: "Private aviation customer acquisition cost benchmarks by tier: jet card, fractional, charter, whole aircraft. CAC ranges, cycle length, channel mix.",
    image: "/images/private-aviation-customer-acquisition-cost-benchmarks.png",
    category: "Vertical Strategy — Private Aviation",
    date: "2026-09-16",
  },
  {
    slug: "streaming-ad-tier-reach-affluent-audiences",
    title: "Streaming Ad-Tier Reach: Affluent Audiences by Platform",
    excerpt: "Streaming ad-tier reach by platform: ad-supported subscriber scale, affluent household composition, the ad-free leakage problem, and how to size HNW reach.",
    image: "/images/streaming-ad-tier-reach-affluent-audiences.png",
    category: "Premium CTV & Streaming",
    date: "2026-09-16",
  },
  {
    slug: "always-on-vs-flighted-advertising-luxury-brands",
    title: "Always-On vs Flighted Advertising for Luxury Brands",
    excerpt: "Always-on vs flighted advertising for luxury brands: how sales-cycle length, ad-effect decay, CPM seasonality and holdout data decide the pacing model.",
    image: "/images/always-on-vs-flighted-advertising-luxury-brands.png",
    category: "Media Strategy & Planning",
    date: "2026-09-17",
  },
  {
    slug: "private-residence-club-fractional-ownership-advertising",
    title: "Private Residence Club Advertising: A Media Playbook",
    excerpt: "Private residence club advertising and fractional ownership marketing: audience sizing, channel economics, CAC benchmarks by share price, and measurement.",
    image: "/images/private-residence-club-fractional-ownership-advertising.png",
    category: "Luxury Vertical Playbooks",
    date: "2026-09-17",
  },
  {
    slug: "everywhere-millionaires-advertising-private-business-owners",
    title: "Everywhere Millionaires: The Wealthy Buyers Ads Miss",
    excerpt: "The Atlantic's \"everywhere millionaires\" research shows most $10M+ Americans are private business owners, not tech or finance. Here is how to reach them.",
    image: "/images/everywhere-millionaires-advertising-private-business-owners.png",
    category: "Affluent Audience Strategy (Special Insight)",
    date: "2026-09-17",
  },
  {
    slug: "ctv-creative-wear-out-rotation-luxury-brands",
    title: "CTV Creative Wear-Out: Rotation Benchmarks for Luxury",
    excerpt: "CTV creative wear-out erodes lift long before spend runs out. Benchmarks for how many spots to run, when to rotate, and how to measure decay for luxury brands.",
    image: "/images/ctv-creative-wear-out-rotation-luxury-brands.png",
    category: "Premium CTV Strategy",
    date: "2026-09-18",
  },
  {
    slug: "ctv-pod-position-ad-load-premium-streaming",
    title: "CTV Pod Position and Ad Load: What Luxury Brands Pay For",
    excerpt: "CTV pod position and ad load shape attention more than CPM does. First-in-pod premiums, ad-load benchmarks by platform, and how luxury brands should buy them.",
    image: "/images/ctv-pod-position-ad-load-premium-streaming.png",
    category: "Premium CTV Strategy",
    date: "2026-09-18",
  },
  {
