...
export const content: IndustryContent = {
  ...
  cta: {
    h2Line1: "Selective",
    h2Line2: "by design",
    body: "We take a limited number of engagements each quarter. If you run an advisory practice or distribute retirement products and acquisition cost is the constraint, apply.",
  },
