...
export const metadata = {
  ...
  "openGraph": {
    ...
    "type": "article",
    "url": "https://www.stillwatermedia.io/insights/media-measurement-beyond-last-click",
    "images": [
      {
        "url": "/images/media-measurement-beyond-last-click.png",
        "width": 1200,
        "height": 630,
        "alt": "Stillwater Media media measurement beyond last click framework showing four analytical layers stacked from experiment to attribution"
      }
    ]
  },
  "twitter": {
    ...
    "description": "Last click is a bookkeeping record, not a causal one. Here is how luxury and high-consideration brands should actually measure media.",
    "images": [
      "/images/media-measurement-beyond-last-click.png"
    ]
  }
}
...
export default function MediaMeasurementBeyondLastClickPage() {
  ...
  return (
    <ArticleLayout
      ...
      imageAlt="Stillwater Media media measurement beyond last click illustration showing four stacked analytical layers with light refracting through each to represent different attribution methods"
      imageCaption="Every measurement method sees the same campaign through a different plane of glass — the discipline is knowing which distortion belongs to which layer."
