...
export default function PrivateClubMembershipPage() {
  ...
  const schemaMarkup = {
    "@context": "https://schema.org",
    "@graph": [articleSchema, {"@type":"BreadcrumbList","@id":"https://www.stillwatermedia.io/insights/private-club-membership-marketing#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.stillwatermedia.io"},{"@type":"ListItem","position":2,"name":"Insights","item":"https://www.stillwatermedia.io/insights"},{"@type":"ListItem","position":3,"name":"Private Club Membership Marketing: How to Drive Qualified Membership Inquiries","item":"https://www.stillwatermedia.io/insights/private-club-membership-marketing"}]}, {"@type":"FAQPage","@id":"https://www.stillwatermedia.io/insights/private-club-membership-marketing#faq","mainEntity":[{"@type":"Question","name":"How do private clubs market to attract new members?","acceptedAnswer":{"@type":"Answer","text":"Effective private club membership marketing combines premium CTV advertising (on Disney+, Peacock, and streaming platforms) with programmatic display in brand-safe publisher environments like WSJ, Bloomberg, and Golf Digest, targeting households by income ($250K+), lifestyle interests, and luxury behavioral signals. The most successful clubs build lookalike audiences from their existing member CRM data and weight campaign spend toward January–March and September–October, when membership inquiry intent peaks."}},{"@type":"Question","name":"What digital advertising channels work best for private club membership marketing?","acceptedAnswer":{"@type":"Answer","text":"The highest-performing digital channel mix for private clubs consists of connected TV for household-level awareness, private marketplace (PMP) programmatic display in premium publisher environments, streaming audio on platforms like Spotify Premium during high-attention moments, and digital out-of-home in locations frequented by affluent prospects (luxury retail, FBO terminals, upscale fitness). Meta and broad programmatic campaigns typically underperform because their audience demographics skew far below the income threshold required for club prospects."}},{"@type":"Question","name":"How do you measure the ROI of private club advertising when sales cycles are so long?","acceptedAnswer":{"@type":"Answer","text":"Private club advertising ROI is best measured through a combination of branded search volume trends (a leading indicator that CTV and audio are driving awareness), inquiry source attribution captured during membership director intake calls, and cohort analysis that tracks each quarter's inquiry class through to application and approval at 6, 12, and 18 months. Standard 7-day click attribution is structurally unable to capture the full value of club advertising given 60–180+ day consideration periods."}},{"@type":"Question","name":"What targeting data is available to reach high-net-worth prospects for a private club?","acceptedAnswer":{"@type":"Answer","text":"Advertisers can reach HNW prospects for private club campaigns using household income segments ($250K–$500K+) from Acxiom, Experian, and LiveRamp; luxury automotive ownership data as a wealth proxy; golf handicap and USGA membership data; private school enrollment overlays; business executive title targeting from B2B data enrichment; and most powerfully, lookalike audiences modeled from the club's own member CRM data. Geographic drive-time radius targeting ensures impressions reach only households with practical access to the facility."}},{"@type":"Question","name":"Should private clubs with a waitlist still advertise?","acceptedAnswer":{"@type":"Answer","text":"Yes — clubs with waitlists benefit from continued advertising for three reasons. First, prospects who identify themselves during a waitlist period can be nurtured and pre-qualified so that capacity openings convert immediately. Second, active advertising reinforces exclusivity and demand perception, strengthening the membership's value signal to current and prospective members. Third, competitors often go dark during waitlist phases, allowing an active club to capture prospect mindshare before capacity opens."}}]}],
  }
