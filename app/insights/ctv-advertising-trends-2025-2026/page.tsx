...
export const metadata = {
  "title": "CTV Advertising for Luxury Brands: Benchmarks and Buying Guide",
  "description": "A media strategist's guide to CTV advertising for luxury brands: platform CPM benchmarks, audience targeting, measurement, and how to buy premium streaming inventory.",
  "alternates": {
    "canonical": "https://www.stillwatermedia.io/insights/ctv-advertising-trends-2025-2026"
  },
  "openGraph": {
    "title": "CTV Advertising for Luxury Brands: Benchmarks and Buying Guide",
    "description": "Streaming has fractured and audiences have migrated. Learn which CTV strategies separate the luxury brands winning premium attention from those wasting it.",
    "type": "article",
    "url": "https://www.stillwatermedia.io/insights/ctv-advertising-trends-2025-2026",
    "images": [
      {
        "url": "/images/ctv-advertising-trends-2025-2026.png",
        "width": 1200,
        "height": 630,
        "alt": "CTV advertising trends 2025–2026 dashboard showing streaming platform data for luxury brands"
      }
    ]
  },
  "twitter": {
    ...
    "title": "CTV Advertising for Luxury Brands: Benchmarks and Buying Guide",
    "description": "The streaming landscape has fundamentally changed. Here's what luxury brand advertisers need to understand about buying and measuring CTV.",
    "images": [
      "/images/ctv-advertising-trends-2025-2026.png"
    ]
  }
}
...
export default function CtvAdvertisingTrends20252026Page() {
  ...
  return (
    <ArticleLayout
      ...
      imageAlt="Stillwater Media CTV advertising trends 2025–2026 strategic dashboard showing streaming platform analytics for luxury brand media planning"
      imageCaption="The streaming landscape has permanently fragmented — and the brands winning premium attention in 2025–2026 are the ones who adapted their CTV strategy accordingly."
