...
export default function FrequencyCappingPage() {
  ...
  const schemaMarkup = {
    "@context": "https://schema.org",
    "@graph": [articleSchema, {"@type":"BreadcrumbList","@id":"https://www.stillwatermedia.io/insights/frequency-capping-programmatic-luxury-brands#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.stillwatermedia.io"},{"@type":"ListItem","position":2,"name":"Insights","item":"https://www.stillwatermedia.io/insights"},{"@type":"ListItem","position":3,"name":"Frequency Capping in Programmatic: The Luxury Brand Advertiser's Guide","item":"https://www.stillwatermedia.io/insights/frequency-capping-programmatic-luxury-brands"}]}, {"@type":"FAQPage","@id":"https://www.stillwatermedia.io/insights/frequency-capping-programmatic-luxury-brands#faq","mainEntity":[{"@type":"Question","name":"What is frequency capping in programmatic advertising?","acceptedAnswer":{"@type":"Answer","text":"Frequency capping in programmatic advertising is a setting that limits how many times a specific user sees a specific ad within a defined time window — typically expressed as impressions per user per day or per week. It prevents individual users from being over-exposed to an ad, which wastes budget and, for luxury brands specifically, can damage brand perception among prospects who interpret repeated ad exposure as brand desperation or poor targeting."}},{"@type":"Question","name":"What is the optimal frequency cap for luxury brand advertising?","acceptedAnswer":{"@type":"Answer","text":"The optimal frequency cap varies by channel and creative format. For CTV and streaming TV, 3–5 impressions per user per week is the recommended range. For premium display, 5–8 per week. For streaming audio, 4–6 per week. For podcast advertising, 2–3 per month maximum. These benchmarks are starting points — campaigns should be monitored via frequency distribution reports and caps adjusted based on actual delivery patterns and brand lift data."}},{"@type":"Question","name":"How does frequency capping affect reach for luxury advertisers?","acceptedAnswer":{"@type":"Answer","text":"Lowering frequency caps increases reach by reallocating suppressed impressions to new users rather than repeating to users who've already hit their limit. For luxury brands with small addressable audiences — such as those targeting ultra-high-net-worth households — the trade-off between frequency and reach requires deliberate planning. Upper-funnel awareness campaigns benefit from broader reach with lower frequency; mid-funnel consideration campaigns can sustain modestly higher frequency to reinforce brand recall."}},{"@type":"Question","name":"How do you manage frequency across multiple advertising channels?","acceptedAnswer":{"@type":"Answer","text":"Cross-channel frequency management requires either identity resolution infrastructure (such as LiveRamp or The Trade Desk's UID2) to unify user identity across channels and apply a master impression cap, or deliberate channel sequencing where channels operate in phases to reduce simultaneous cross-channel overlap. Without cross-channel coordination, a user can see a technically compliant number of impressions on each individual channel while experiencing a total weekly ad exposure of 15+ impressions — which degrades both brand perception and campaign efficiency."}},{"@type":"Question","name":"Should luxury brands use the same frequency cap for retargeting as for prospecting?","acceptedAnswer":{"@type":"Answer","text":"No — retargeting and prospecting audiences have different frequency tolerances. Prospecting audiences (users with no prior brand engagement) are in early-awareness mode and benefit from lower frequency with broader reach. Retargeting audiences (site visitors, CRM matches, high-intent prospects) have already engaged and can sustain modestly higher frequency — but the creative must advance the brand narrative rather than repeat the same message. Even for high-intent retargeting, caps above 10–12 impressions per week per channel are counterproductive for luxury brands."}}]}],
  }
